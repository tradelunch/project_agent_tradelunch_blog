...
tags: [langchain, llm, ai, python, agents, rag, memory]
desc: A comprehensive beginner's guide to LangChain framework for building LLM applications. Covers chains, agents, memory systems, and RAG with practical examples.
date: 2026-01-03
userId: 4
username: taeklim
status: "public"
...
![langchain-guide thumbnail](langchain-guide.png)
